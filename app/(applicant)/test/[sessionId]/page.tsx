...
export default function TestSessionPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="test-session-page">
      {/* Header */}
        ...
        <div className="max-w-5xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-6">
              ...
              {/* Saving indicator */}
              {saving && (
                <span className="text-xs text-gray-500">Ukladám...</span>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-2">
            {questions.map((q, index) => (
              <button
                ...
                } ${currentQuestionIndex === index && viewMode === 'single' ? 'ring-2 ring-blue-600' : ''}`}
